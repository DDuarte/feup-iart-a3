...
namespace IART_A3
{
    public static class Program
    {
        static void Main()
        {
            var lots = new ReadOnlyDictionary<string, Lot>(new Dictionary<string, Lot>
            {
            ...
            var landuses = new ReadOnlyDictionary<string, Landuse>(new Dictionary<string, Landuse>
            {
            ...
            var softConstraints = new ReadOnlyDictionary<string, ISoftConstraint>(new Dictionary<string, ISoftConstraint>());
